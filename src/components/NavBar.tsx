...
export default function NavBar({ lngCh }: any) {
  ...
  return (
    <nav className={navbarCls}>
      <div className="justify-between mx-auto w-[95%] lg:container md:items-center md:flex">
        <div className="">
        ...
        <div>
          ...
          >
            <ul className="items-center justify-center space-y-8 md:flex md:space-x-2 2xl:space-x-6 md:space-y-0 py-[30px] text-white font-chakrapetch uppercase font-bold">
              ...
              <li>
                <a href={'https://poocoin.app/tokens/0x2da63e26978b27ca854bdfe33f9866aa7c99813d'}><Trans i18nKey="tab_poocoin">PooCoin</Trans></a>
              </li>
              <li>
              ...
              <li>
                <a href="https://bscscan.com/address/0x2da63e26978b27ca854bdfe33f9866aa7c99813d"><Trans i18nKey="tab_smartcontact">Smart Contract</Trans>
                </a>
              </li>
              <li>
                <NavLink to="/news"><Trans i18nKey="tab_news">News</Trans></NavLink>
              </li>
              <li>
        ...
        <div className="hidden lg:inline-block space-x-2">
          <a href="https://pancakeswap.finance/swap?outputCurrency=0x2dA63e26978B27CA854bdFe33F9866AA7c99813D"
            target={'_blank'}
            className="px-4 py-2 text-white rounded-0 border-[2px] rounded-[4px]  border-[#3d4db5] font-bold font-chakrapetch hover:text-[#3d4db5] hover:border-transparent hover:bg-white uppercase transition ease-in-ease"
          ><Trans i18nKey="btn_buyalgo">buy algo</Trans>
          </a>
