    ...
    <div className="home mt-[0px]">
      <div className='home-content' id='home'>
        ...
        <div className='container mx-auto'>
          ...
          <div className='lg:flex block pt-[60px] lg:pt-[160px] xl:pt-[180px] mt-[0px]'>
            <div className='w-[90%] lg:w-[55%] text-center items-center m-auto'>
              ...
              <div className='wrap-btn md:flex'>
                <SocialIcon url='https://www.facebook.com/Algonrich-100854022676795' fgColor='white' bgColor="transparent" className='text-[20px] md:text-[30px] custom-btn px-[10px] sm:py-0 sm:px-[32px] font-chakrapetch w-[100%] lg:w-auto  mr-[15px] my-[5px] md:justify-start' />
                <SocialIcon url='https://twitter.com/algonrich' bgColor="transparent" fgColor='white' className='text-[20px] md:text-[30px] custom-btn px-[10px] sm:py-0 sm:px-[32px] font-chakrapetch w-[100%] lg:w-auto mr-[15px] my-[5px] md:justify-start' />
                <SocialIcon url='https://www.instagram.com/algonrich' bgColor="transparent" fgColor='white' className='text-[20px] md:text-[30px] custom-btn px-[10px] sm:py-0 sm:px-[32px] font-chakrapetch w-[100%] lg:w-auto mr-[15px] my-[5px] md:justify-start' />
                <SocialIcon url='https://github.com/Algonrich' bgColor="transparent" fgColor='white' className='text-[20px] md:text-[30px] custom-btn px-[10px] sm:py-0 sm:px-[32px] font-chakrapetch w-[100%] lg:w-auto mr-[15px] my-[5px] md:justify-start' />
                <SocialIcon url='https://www.youtube.com/channel/UCWjfEAgHV-ow71I3VrWjCVw' fgColor='white' bgColor="transparent" className='text-[20px] md:text-[30px] custom-btn px-[10px] sm:py-0 sm:px-[32px] font-chakrapetch w-[100%] lg:w-auto mr-[15px] my-[5px] md:justify-start' />
                <SocialIcon url='https://t.me/algonrich_us_official' bgColor="transparent" fgColor='white' className='text-[20px] md:text-[30px] custom-btn px-[10px] sm:py-0 sm:px-[32px] font-chakrapetch w-[100%] lg:w-auto mr-[15px] my-[5px] md:justify-start' />
                <a href="https://discord.gg/SKmc2QUTc9" className='text-[20px] md:text-[30px] custom-btn discord-btn px-[10px] sm:py-0 font-chakrapetch  relative align-middle mr-[15px] my-[5px] md:justify-start inline-block '>
                  <img src="/assets/images/discord.svg" alt="" className='w-[30px] md:w-[50px] h-[50px] py-[12px]' />
                </a>
              </div>
            </div>
            <div className='video w-[90%] lg:w-[45%] mt-[50px] mx-auto lg:m-auto'>
      ...
      <div className='about-us' id='about'>
        <div className='w-[90%] md:container mx-auto'>
          ...
          >
            <div className='w-[90%] sm:w-[43%] m-auto'>
            ...
            <div className='w-[90%] sm:w-[57%] m-auto'>
      ...
      <div className='team mt-[30px]' id='team'>
        <div className='container mx-auto'>
          <div className='lg:flex'>
            <div className='w-[90%] m-auto lg:w-[40%] px-[15px] aos-init'
              data-aos="fade-up"
              data-aos-duration="1000"
              data-aos-delay="50"
            ...
            <div className='w-[90%] m-auto lg:w-[60%] p-[20px] aos-init'
              data-aos="fade-up"
              data-aos-duration="1000"
              data-aos-delay="50"
              data-aos-anchor-placement="center-bottom"
          ...
          <div className='flex justify-center mt-[70px] mb-[40px] align-middle w-[90%] mx-auto space-x-1 md:space-x-3'>
            <SocialIcon url='https://www.facebook.com/Algonrich-100854022676795' fgColor='white' className='text-[20px] md:text-[30px]' />
            <SocialIcon url='https://twitter.com/algonrich' fgColor='white' className='text-[20px] md:text-[30px]' />
            <SocialIcon url='https://www.instagram.com/algonrich' fgColor='white' className='text-[20px] md:text-[30px]' />
            <SocialIcon url='https://github.com/Algonrich' fgColor='white' className='text-[20px] md:text-[30px]' />
            <SocialIcon url='https://www.youtube.com/channel/UCWjfEAgHV-ow71I3VrWjCVw' fgColor='white' className='text-[20px] md:text-[30px]' />
            <SocialIcon url='https://t.me/algonrich_us_official' fgColor='white' className='text-[20px] md:text-[30px]' />
            <SocialIcon url='https://discord.gg/SKmc2QUTc9' fgColor='white' className='text-[20px] md:text-[30px]' />
          </div>
      ...
      <div className='footer border-t-[1px]  border-[#0c1226]'>
        <div className="copyright container m-auto py-[20px] px-[5px] text-center md:text-start font-chakrapetch text-[14px]">
